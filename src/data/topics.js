const topics = [
  ...
  },
  {
    ...
    subtopics: [
      ...
      {
        id: "glacial-depositional",
        name: "Depositional Landforms",
        flashcards: [
          { id: "gd1", front: "What materials do glaciers deposit?", back: "Till, moraines, erratics and outwash — debris picked up from the underlying rock surface and surrounding landscape." },
          { id: "gd2", front: "What are Moraines?", back: "Accumulations of glacial debris (till) forming ridges or mounds at different points around a glacier. The most common glacial depositional landforms." },
          { id: "gd3", front: "What are the four types of Moraines?", back: "1. Lateral Moraines — along sides of glacier from debris falling from surrounding slopes\n2. Medial Moraines — where two glaciers merge, lateral moraines combine into a central ridge\n3. Terminal (End) Moraines — at the farthest point of glacier advance, marking maximum extent\n4. Ground Moraines — blanket of till left behind as glacier retreats" },
          { id: "gd4", front: "What are Eskers?", back: "Long, winding ridges of sand and gravel deposited by subglacial streams flowing beneath a glacier. Can be several kilometers long, resembling raised riverbeds tracing former subglacial rivers.\nExample: Munro Esker in Canada — over 250 km long." },
          { id: "gd5", front: "What are Kame Terraces?", back: "Small, irregularly shaped hills or mounds of sand, gravel and till deposited by meltwater in depressions on the glacier's surface or margins. Sediment deposited in meltwater lakes/channels is left as mounds when glacier melts." },
          { id: "gd6", front: "What are Kettle Holes?", back: "Depressions formed when chunks of ice break off a retreating glacier and become buried in till. As ice melts, sediment collapses forming a depression that fills with water. Kettle lakes are often circular." },
          { id: "gd7", front: "What are Drumlins?", back: "Smooth, elongated oval-shaped hills of glacial till. One end (stoss) faces the glacier, the narrow end (tail) points in the direction of glacier movement. They indicate the direction of glacier movement." },
          { id: "gd8", front: "What are Outwash Plains?", back: "Broad, flat areas of stratified sediment deposited by meltwater streams from the glacier. Located in front of the terminal moraine. Characterised by flat, expansive nature with layered sediment." },
          { id: "gd9", front: "What are Nunataks?", back: "Also called 'glacial islands' — mountain peaks or rock formations exposed above a glacier or ice sheet." },
          { id: "gd10", front: "What are Crevasses and Bergschrunds?", back: "Crevasses: fissures or cracks in a glacier from stress produced by movement.\nBergschrund: a special crevasse — a crack between moving glacier ice and non-moving (stagnant) ice of a mountain or cliff." },
        ],
        quizzes: [
          { id: "gdq1", question: "Terminal Moraines mark:", options: ["The center of a glacier", "The maximum extent of glacier advance", "The sides of a glacier", "The base of a mountain"], correct: 1 },
          { id: "gdq2", question: "Medial Moraines form when:", options: ["A glacier retreats", "Two glaciers merge and their lateral moraines combine", "Ice melts and leaves debris", "Wind deposits sand on ice"], correct: 1 },
          { id: "gdq3", question: "Eskers are deposited by:", options: ["Wind", "Subglacial meltwater streams", "Ocean currents", "Rivers on the surface"], correct: 1 },
          { id: "gdq4", question: "Kettle Holes form when:", options: ["Glaciers erode bedrock", "Buried ice chunks melt and sediment collapses", "Rivers deposit sediment", "Wind creates depressions"], correct: 1 },
          { id: "gdq5", question: "Drumlins indicate:", options: ["Wind direction", "River flow direction", "Direction of glacier movement", "Tectonic plate movement"], correct: 2 },
          { id: "gdq6", question: "The 'stoss' end of a drumlin faces:", options: ["Downwind", "The glacier", "Away from the glacier", "The ocean"], correct: 1 },
          { id: "gdq7", question: "Outwash Plains are located:", options: ["Behind the glacier", "In front of the terminal moraine", "On top of the glacier", "Inside caves"], correct: 1 },
          { id: "gdq8", question: "Nunataks are:", options: ["Glacial lakes", "Rock formations exposed above a glacier", "Types of moraines", "Subglacial streams"], correct: 1 },
          { id: "gdq9", question: "A Bergschrund is a crack between:", options: ["Two glaciers", "Moving glacier ice and stagnant ice of a mountain", "Two mountain peaks", "A lake and a river"], correct: 1 },
          { id: "gdq10", question: "Which moraine type covers the landscape as a blanket of till?", options: ["Lateral", "Medial", "Terminal", "Ground"], correct: 3 },
        ],
      },
    ],
  },
